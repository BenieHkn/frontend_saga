            ...
            <div class="relative">
              <button @click="toggleUserMenu" type="button"
                ...
                <div class="p-0.5 rounded-xl">
                  <img class="h-9 w-9 rounded-[10px] object-cover bg-white" :src="getInitials(user?.nom, user?.prenom)" alt="User" />
                </div>
                <div class="hidden md:block ml-3 text-left mr-2">
                  <p class="text-xs font-bold text-white leading-none uppercase">{{ user?.prenom }}</p>
