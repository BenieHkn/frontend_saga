<template>
  <aside :class="[
    ...
    <nav class="flex-1 px-3 py-6 space-y-2 overflow-y-auto no-scrollbar">
      ...
      <div v-if="peutVoirConfig()" class="pt-4 mt-4 border-t border-gray-200">
        ...
        >
          ...
          <Icon
            v-if="isExpanded"
            :name="settingsMenuOpen ? 'heroicons:chevron-up' : 'heroicons:chevron-down'"
    ...
    >
      ...
      <Icon
        :name="isExpanded ? 'heroicons:chevron-left-20-solid' : 'heroicons:chevron-right-20-solid'"
