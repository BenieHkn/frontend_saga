        ...
        <div class="overflow-y-auto flex-1 p-5 space-y-5">
          <section class="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div class="flex items-center justify-between px-4 py-2.5 bg-slate-50 border-b border-slate-100">
              <div class="flex items-center gap-2">
                ...
                <span class="inline-flex px-2 py-0.5 text-[10px] font-bold rounded-full border uppercase ml-1" :class="{
            ...
            <div class="p-4 space-y-3">
              ...
              <div v-if="arriveeFileLoaded" class="mt-2 rounded-lg overflow-hidden border border-slate-200">
          ...
          <section v-if="selectedCourrier.document?.reponse"
            ...
            <div v-else-if="reponseData" class="p-4 space-y-3">
              ...
              <div v-if="reponseFileLoaded" class="mt-2 rounded-lg overflow-hidden border border-emerald-200">
                <DocumentRpreview :file-preview-url="reponseBlobUrl" height="600px" />
              </div>
              <div v-else-if="!reponseData.rawUrl"
...
const refresh = async (page = 1, per_page = perPage.value, isFirst = false) => {
  ...
  try {
    ...
    const response = await $fetch(`${base}/courriers-arrives/large-diffusion?${params.toString()}`, {
      headers: { Authorization: `Bearer ${authToken}` },
    })
