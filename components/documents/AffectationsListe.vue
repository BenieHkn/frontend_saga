      ...
      <template #actions="{ item }">
        <div class="flex gap-1.5 justify-end">
          ...
          <button 
            ...
            class="inline-flex items-center justify-center w-8 h-8 rounded-md border border-transparent hover:bg-blue-50 hover:border-blue-200 transition-all group disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button 
            ...
            class="inline-flex items-center justify-center w-8 h-8 rounded-md border border-transparent hover:bg-green-50 hover:border-green-200 transition-all group disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Icon name="i-heroicons-arrow-path-rounded-square" class="w-4 h-4 text-slate-500 group-hover:text-green-600" />
          </button>
        </div>
      </template>
