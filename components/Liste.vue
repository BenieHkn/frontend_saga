            ...
            <thead class="bg-gray-50 border border-gray-400">
              ...
              <tr>
                ...
                <th class="px-6 py-3 text-left border border-gray-400 bg-gray-100">
                  <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                      <span class="text-xs font-medium text-gray-700 uppercase tracking-wider">Structure / Usager</span>
                      <div class="flex flex-col items-center">
                        <Icon
                ...
                <th class="px-6 py-3 text-left border border-gray-400 bg-gray-100">
                  <div class="space-y-2">
                    <div class="flex items-center space-x-2">
                      <span class="text-xs font-medium text-gray-700 uppercase tracking-wider">N° d'enregistrement</span>
                      <div class="flex flex-col items-center">
                        <Icon
