import { ref, computed, mergeProps, withCtx, createVNode, unref, createTextVNode, createBlock, createCommentVNode, openBlock, toDisplayString, withDirectives, vModelText, Fragment, renderList, useSSRContext } from 'vue';
...
import { u as useHead, _ as _export_sfc, c as __nuxt_component_0$2, d as __nuxt_component_1$1, b as useRuntimeConfig, r as useToast, n as navigateTo } from './server.mjs';
  ...
  const fetchTransferts = async () => {
    ...
    try {
      ...
      if (peutVoirConfig()) {
        ...
        if (!(entite_user == null ? void 0 : entite_user.id)) {
          throw new Error("Aucune fonction utilisateur s\xE9lectionn\xE9e");
        }
        const emetteurId = isSecDir() ? (_a = getDirecteurEntiteUserId()) != null ? _a : entite_user.id : entite_user.id;
        console.log(`\u{1F4DD} Chargement transferts pour emetteur_id: ${emetteurId}`);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const columns = ref([
      ...
      { key: "emetteur", label: "\xC9metteur", visible: true },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(peutTransferer)() && !unref(isAdmin)()) {
      ...
      if (unref(loading)) {
        ...
        _push(ssrRenderComponent(_sfc_main$5, {
          ...
          actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex gap-1.5 justify-end"${_scopeId}><button title="Voir les d\xE9tails" class="inline-flex items-center justify-center w-8 h-8 bg-amber-50 text-amber-700 border-amber-100 rounded-md hover:bg-amber-200 hover:border-amber-900 transition-all group"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
              ...
              _push2(`</button>`);
              if (unref(peutTransferer)() && !unref(isAdmin)()) {
                _push2(`<button class="inline-flex items-center justify-center w-8 h-8 bg-emerald-50 text-emerald-700 border-emerald-100 rounded-md hover:bg-emerald-200 hover:border-emerald-900 transition-all group" title="Modifier"${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
              ...
              return [
                createVNode("div", { class: "flex gap-1.5 justify-end" }, [
                  ...
                  unref(peutTransferer)() && !unref(isAdmin)() ? (openBlock(), createBlock("button", {
                    key: 0,
          ...
          "selection-actions": withCtx(({ selected }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                unref(peutTransferer)() ? (openBlock(), createBlock("button", {
                  key: 0,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const { getEmetteurId, isAdmin } = useAuth();
    ...
    const transformAffectation = (affectation) => {
      ...
      if ((_d = (_c = affectation.emetteur) == null ? void 0 : _c.entite) == null ? void 0 : _d.code) {
      ...
      return {
        ...
        reference_courrier: ((_f = (_e = affectation.courrier_arrive) == null ? void 0 : _e.document) == null ? void 0 : _f.reference) || "",
        objet_courrier: ((_h = (_g = affectation.courrier_arrive) == null ? void 0 : _g.document) == null ? void 0 : _h.objet) || "",
        doc_courrier: ((_j = (_i = affectation.courrier_arrive) == null ? void 0 : _i.document) == null ? void 0 : _j.url) ? affectation.courrier_arrive.document.url !== "Inconnu" ? `${config.public.apiBase}${affectation.courrier_arrive.document.url}` : "" : "",
        ...
        destinataire: {
          nom: ((_k = affectation.destinataire) == null ? void 0 : _k.user) ? `${affectation.destinataire.user.nom} ${affectation.destinataire.user.prenom || ""}`.trim() : "Non assign\xE9",
          fonction: fonctionDestinataire,
          entite: ((_m = (_l = affectation.destinataire) == null ? void 0 : _l.entite) == null ? void 0 : _m.libelle) || ""
        },
        emetteur: {
          nom: ((_n = affectation.emetteur) == null ? void 0 : _n.user) ? `${affectation.emetteur.user.nom} ${affectation.emetteur.user.prenom || ""}`.trim() : "Non assign\xE9",
          fonction: fonctionEmetteur,
          entite: ((_p = (_o = affectation.emetteur) == null ? void 0 : _o.entite) == null ? void 0 : _p.libelle) || ""
        },
        _raw: affectation
      };
    };
    ...
    const fetchDestinataires = async () => {
      ...
      try {
        ...
        if (false) ;
        if (!entite_user || !entite_user.id) {
          toast.add({ title: "Erreur", description: "Aucune fonction utilisateur s\xE9lectionn\xE9e.", color: "red", timeout: 1500 });
          return;
        }
        const emetteurId = (_a = getEmetteurId()) != null ? _a : entite_user.id;
    ...
    const confirmChangeDestinataire = async () => {
      ...
      try {
        ...
        toast.add({ title: "Succ\xE8s", description: "Le destinataire a \xE9t\xE9 modifi\xE9 avec succ\xE8s", color: "green", timeout: 1500 });
    ...
    const handleOpenDocument = (url) => {
      if (url) {
        ...
        toast.add({ title: "Information", description: "Aucun document disponible", color: "amber", timeout: 2e3 });
      }
    };
  ...
  `;
    ...
    const handleBulkExport = (selected) => {
      toast.add({ title: "Information", description: "Fonctionnalit\xE9 d'export en cours de d\xE9veloppement", color: "amber", timeout: 2e3 });
    };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$2;
      const _component_UBadge = __nuxt_component_1;
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 max-w-[1400px] mx-auto" }, _attrs))} data-v-fd35bd3d><div class="flex items-center justify-between mb-6" data-v-fd35bd3d><h1 class="flex items-center gap-3 text-2xl font-bold text-slate-800" data-v-fd35bd3d>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "i-heroicons-document-arrow-down",
        class: "w-7 h-7 text-blue-600"
      }, null, _parent));
      _push(` Affectations </h1><div class="flex items-center gap-3" data-v-fd35bd3d><button class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-700 bg-white border border-slate-300 rounded-lg hover:bg-slate-50 transition-all hover:shadow-md" data-v-fd35bd3d>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "i-heroicons-arrow-path",
        class: "w-4 h-4"
      }, null, _parent));
      ...
      _push(`</div></div>`);
      if (error.value) {
        _push(`<div class="flex items-center gap-3 p-4 mb-5 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm" data-v-fd35bd3d>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "i-heroicons-exclamation-triangle",
          class: "w-5 h-5 flex-shrink-0"
        }, null, _parent));
        _push(`<span class="flex-1" data-v-fd35bd3d>${ssrInterpolate(error.value)}</span><button class="text-lg opacity-60 hover:opacity-100 transition-opacity" data-v-fd35bd3d>\u2715</button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (loading.value) {
        _push(`<div class="flex flex-col items-center justify-center py-16 gap-4" data-v-fd35bd3d><div class="w-12 h-12 border-4 border-gray-200 border-t-blue-600 rounded-full animate-spin" data-v-fd35bd3d></div><p class="text-sm text-slate-500" data-v-fd35bd3d>Chargement des affectations...</p></div>`);
      } else {
        _push(ssrRenderComponent(_sfc_main$5, {
          ...
          "cell-reference_courrier": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800" data-v-fd35bd3d${_scopeId}>${ssrInterpolate(value)}</span>`);
            } else {
              return [
          ...
          "cell-statut": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="${ssrRenderClass([getStatutClasses(value), "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold uppercase tracking-wide"])}" data-v-fd35bd3d${_scopeId}><span class="${ssrRenderClass([getStatutDotClass(value), "w-2 h-2 rounded-full mr-1.5"])}" data-v-fd35bd3d${_scopeId}></span> ${ssrInterpolate(getStatutLabel(value))}</span>`);
            } else {
              return [
                createVNode("span", {
          ...
          "cell-priority": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="${ssrRenderClass([getPriorityClasses(value), "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold uppercase tracking-wide"])}" data-v-fd35bd3d${_scopeId}><span class="${ssrRenderClass([getPriorityDotClass(value), "w-2 h-2 rounded-full mr-1.5"])}" data-v-fd35bd3d${_scopeId}></span> ${ssrInterpolate(getPriorityLabel(value))}</span>`);
            } else {
              return [
                createVNode("span", {
          ...
          "cell-emetteur": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="text-left" data-v-fd35bd3d${_scopeId}><div class="font-medium text-xs text-slate-800" data-v-fd35bd3d${_scopeId}>${ssrInterpolate(value.nom)}</div><div class="text-xs text-slate-500" data-v-fd35bd3d${_scopeId}>${ssrInterpolate(value.fonction)}</div></div>`);
            } else {
              return [
          ...
          "cell-instructions": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="block max-w-[300px] line-clamp-2 text-xs text-slate-700"${ssrRenderAttr("title", value)} data-v-fd35bd3d${_scopeId}>${ssrInterpolate(value || "Aucune instruction")}</span>`);
            } else {
              return [
                createVNode("span", {
          ...
          actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex gap-1.5 justify-end" data-v-fd35bd3d${_scopeId}><button title="Voir les d\xE9tails" class="inline-flex items-center justify-center w-8 h-8 bg-amber-50 text-amber-700 border-amber-100 rounded-md hover:bg-amber-200 transition-all group" data-v-fd35bd3d${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "i-heroicons-eye",
                class: "w-4 h-4 group-hover:text-yellow-600"
              }, null, _parent2, _scopeId));
              _push2(`</button>`);
              if (!unref(isAdmin)()) {
                _push2(`<button title="Affecter ce courrier" class="inline-flex items-center justify-center w-8 h-8 bg-sky-50 text-sky-700 border-sky-100 rounded-md hover:bg-sky-200 transition-all group" data-v-fd35bd3d${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
              ...
              if (!unref(isAdmin)()) {
                _push2(`<button class="inline-flex items-center justify-center w-8 h-8 bg-emerald-50 text-emerald-700 border-emerald-100 rounded-md hover:bg-emerald-200 transition-all group" title="Modifier le destinataire" data-v-fd35bd3d${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-pencil",
                  class: "w-4 h-4 group-hover:text-green-600"
                }, null, _parent2, _scopeId));
          ...
          "cell-reference": withCtx(({ value, item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (item.url) {
                _push2(`<button class="inline-flex items-center gap-1.5 px-2.5 py-0.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 hover:border-blue-300 rounded-md transition-all group"${ssrRenderAttr("title", `Ouvrir le document ${value}`)} data-v-fd35bd3d${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-document-text",
                  class: "w-3.5 h-3.5 group-hover:scale-110 transition-transform"
                }, null, _parent2, _scopeId));
                _push2(`<span data-v-fd35bd3d${_scopeId}>${ssrInterpolate(value)}</span>`);
                _push2(ssrRenderComponent(_component_Icon, {
                ...
                _push2(`<span class="inline-flex items-center px-2.5 py-0.5 text-xs font-medium text-gray-600 bg-gray-100 rounded-md"${ssrRenderAttr("title", value)} data-v-fd35bd3d${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-document-text",
          ...
          "selection-actions": withCtx(({ selected }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-red-700 bg-red-50 border border-red-200 rounded-md hover:bg-red-100 hover:border-red-300 transition-all" data-v-fd35bd3d${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "i-heroicons-trash",
                class: "w-4 h-4"
              }, null, _parent2, _scopeId));
              _push2(` Supprimer (${ssrInterpolate(selected.length)}) </button><button class="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100 hover:border-blue-300 transition-all" data-v-fd35bd3d${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "i-heroicons-arrow-down-tray",
                class: "w-4 h-4"
              }, null, _parent2, _scopeId));
              ...
              return [
                ...
                createVNode("button", {
                  onClick: ($event) => handleBulkExport(),
          ...
          "advanced-filters": withCtx(({ filters, onFilter }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" data-v-fd35bd3d${_scopeId}><div data-v-fd35bd3d${_scopeId}><label class="block text-xs font-medium text-gray-700 mb-1" data-v-fd35bd3d${_scopeId}>Date d&#39;affectation</label><input${ssrRenderAttr("value", filters.date_affect)} type="date" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" data-v-fd35bd3d${_scopeId}></div><div data-v-fd35bd3d${_scopeId}><label class="block text-xs font-medium text-gray-700 mb-1" data-v-fd35bd3d${_scopeId}>Date de retour attendue</label><input${ssrRenderAttr("value", filters.delai_traitement)} type="date" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" data-v-fd35bd3d${_scopeId}></div><div data-v-fd35bd3d${_scopeId}><label class="block text-xs font-medium text-gray-700 mb-1" data-v-fd35bd3d${_scopeId}>Date de cl\xF4ture</label><input${ssrRenderAttr("value", filters.date_cloture)} type="date" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" data-v-fd35bd3d${_scopeId}></div></div>`);
            } else {
              return [
      ...
      _push(ssrRenderComponent(_component_UModal, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="p-6" data-v-fd35bd3d${_scopeId}><div class="flex items-center justify-between mb-6" data-v-fd35bd3d${_scopeId}><h3 class="text-xl font-bold text-gray-900 flex items-center gap-2" data-v-fd35bd3d${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
            ...
            if (selectedAffectation.value) {
              _push2(`<div class="bg-blue-50 rounded-lg p-4 mb-6 border border-blue-200" data-v-fd35bd3d${_scopeId}><p class="text-sm text-gray-700 mb-2" data-v-fd35bd3d${_scopeId}><strong data-v-fd35bd3d${_scopeId}>Courrier :</strong> ${ssrInterpolate(selectedAffectation.value.reference_courrier)}</p><p class="text-xs text-gray-600" data-v-fd35bd3d${_scopeId}>${ssrInterpolate(selectedAffectation.value.objet_courrier)}</p><div class="mt-3 pt-3 border-t border-blue-200" data-v-fd35bd3d${_scopeId}><p class="text-sm text-gray-700" data-v-fd35bd3d${_scopeId}><strong data-v-fd35bd3d${_scopeId}>Destinataire actuel :</strong><span class="text-blue-700 font-semibold" data-v-fd35bd3d${_scopeId}>${ssrInterpolate(selectedAffectation.value.destinataire.nom)}</span><span class="text-xs text-gray-500 ml-2" data-v-fd35bd3d${_scopeId}>(${ssrInterpolate(selectedAffectation.value.destinataire.fonction)})</span></p></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="mb-4" data-v-fd35bd3d${_scopeId}><label class="block text-sm font-medium text-gray-700 mb-2" data-v-fd35bd3d${_scopeId}>Rechercher un destinataire</label><input${ssrRenderAttr("value", searchDestinataire.value)} type="text" placeholder="Rechercher par nom, pr\xE9nom ou fonction..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" data-v-fd35bd3d${_scopeId}></div>`);
            if (loadingDestinataires.value) {
              _push2(`<div class="flex justify-center py-8" data-v-fd35bd3d${_scopeId}><div class="w-8 h-8 border-4 border-gray-200 border-t-blue-600 rounded-full animate-spin" data-v-fd35bd3d${_scopeId}></div></div>`);
            } else {
              _push2(`<div class="max-h-96 overflow-y-auto border border-gray-200 rounded-lg" data-v-fd35bd3d${_scopeId}><!--[-->`);
              ssrRenderList(filteredDestinataires.value, (dest) => {
                ...
                ])}" data-v-fd35bd3d${_scopeId}><div class="flex items-center justify-between" data-v-fd35bd3d${_scopeId}><div class="flex-1" data-v-fd35bd3d${_scopeId}><p class="font-semibold text-gray-900" data-v-fd35bd3d${_scopeId}>${ssrInterpolate((_b2 = dest.user) == null ? void 0 : _b2.nom)} ${ssrInterpolate((_c = dest.user) == null ? void 0 : _c.prenom)}</p><p class="text-sm text-gray-600 mt-1" data-v-fd35bd3d${_scopeId}><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-700 mr-2" data-v-fd35bd3d${_scopeId}>${ssrInterpolate((_d = dest.entite) == null ? void 0 : _d.code)}</span>`);
                if (dest.is_responsable) {
                  _push2(`<span class="text-gray-700" data-v-fd35bd3d${_scopeId}>${ssrInterpolate((_e = dest.entite) == null ? void 0 : _e.fonction)}</span>`);
                } else {
                  _push2(`<span class="text-gray-500" data-v-fd35bd3d${_scopeId}>Agent</span>`);
                }
                _push2(`</p><p class="text-xs text-gray-500 mt-1" data-v-fd35bd3d${_scopeId}>${ssrInterpolate((_f = dest.entite) == null ? void 0 : _f.libelle)}</p></div>`);
                if (((_g = selectedNewDestinataire.value) == null ? void 0 : _g.id) === dest.id) {
                  _push2(`<div data-v-fd35bd3d${_scopeId}>`);
                  _push2(ssrRenderComponent(_component_Icon, {
              ...
              if (filteredDestinataires.value.length === 0) {
                _push2(`<div class="p-8 text-center text-gray-500" data-v-fd35bd3d${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-user-group",
                  class: "h-12 w-12 mx-auto mb-2 text-gray-400"
                }, null, _parent2, _scopeId));
                _push2(`<p class="text-sm" data-v-fd35bd3d${_scopeId}>Aucun destinataire trouv\xE9</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            }
            _push2(`<div class="flex justify-end gap-3 mt-6" data-v-fd35bd3d${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UButton, {
              onClick: ($event) => showEditModal.value = false,
              color: "gray",
              variant: "outline",
...
const AffectationsEmises = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-fd35bd3d"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=index-DoqFIch-.mjs.map
