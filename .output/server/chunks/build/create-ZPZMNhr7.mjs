import { d as __nuxt_component_1, n as navigateTo } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div><label class="block text-sm font-medium text-gray-700 mb-2"> Entit\xE9 Parent </label><div class="relative"><div class="relative"><input${ssrRenderAttr("value", unref(searchEntiteParent))} type="text" placeholder="Rechercher une entit\xE9 parent..." class="w-full h-12 px-3 py-2 pr-10 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900"${ssrIncludeBooleanAttr(_ctx.loading) ? " disabled" : ""}><svg class="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg></div>`);
      ...
      if (_ctx.selectedParent) {
        _push(`<div class="mt-2 inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 border border-blue-200 rounded-md"><div class="flex flex-col"><span class="text-sm font-medium text-blue-900">${ssrInterpolate(_ctx.selectedParent.code)} - ${ssrInterpolate(_ctx.selectedParent.libelle)}</span>`);
        if (_ctx.selectedParent.fonction) {
          _push(`<span class="text-xs text-blue-700">${ssrInterpolate(_ctx.selectedParent.fonction)}</span>`);
        } else {
          _push(`<!---->`);
        }
      ...
      _push(ssrRenderComponent(_component_UButton, {
        disabled: !unref(isFormValid) || _ctx.loading,
        type: "submit",
      ...
      if (_ctx.errorRequest) {
        _push(`<div class="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg"><p class="text-sm text-red-600"><strong>Erreur serveur :</strong> ${ssrInterpolate(_ctx.errorRequest.message || ((_a = _ctx.errorRequest.data) == null ? void 0 : _a.message) || "Une erreur est survenue")}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</form></div></div><div class="lg:col-span-6"><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6"><h3 class="text-lg font-semibold text-gray-900 mb-4">Informations sur les points critiques</h3><div class="space-y-4"><div class="bg-blue-50 border border-blue-200 rounded-lg p-4"><h4 class="font-medium text-blue-800 mb-2">\xC0 propos des points critiques</h4><p class="text-sm text-blue-700"> Les points critiques repr\xE9sentent les diff\xE9rentes unit\xE9s organisationnelles de votre structure. Chaque point critique peut avoir une entit\xE9 parent pour \xE9tablir une hi\xE9rarchie claire. </p></div><div class="bg-purple-50 border border-purple-200 rounded-lg p-4"><h4 class="font-medium text-purple-800 mb-2">Guide des champs</h4><ul class="space-y-2 text-sm text-purple-700"><li><strong>Code :</strong> Identifiant unique court (ex: DIR, DRH)</li><li><strong>Libell\xE9 :</strong> Nom complet du point critique</li><li><strong>Fonction :</strong> R\xF4le ou mission du point critique (optionnel)</li><li><strong>Entit\xE9 Parent :</strong> Position dans la hi\xE9rarchie (optionnel)</li></ul></div>`);
      if (unref(entitesList).length > 0) {
        ...
        _push(`<div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4"><h4 class="font-medium text-yellow-800 mb-2">Aucune entit\xE9 disponible</h4><p class="text-sm text-yellow-700"> Ce point critique sera le premier de la hi\xE9rarchie. </p></div>`);
      }
      if (unref(form).code || unref(form).libelle) {
        ...
        if (_ctx.selectedParent) {
          _push(`<div class="flex items-center space-x-2"><span class="text-slate-600">Entit\xE9 parent:</span><span class="font-semibold text-slate-900">${ssrInterpolate(_ctx.selectedParent.code)} - ${ssrInterpolate(_ctx.selectedParent.libelle)}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/point-critique/create.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=create-ZPZMNhr7.mjs.map
