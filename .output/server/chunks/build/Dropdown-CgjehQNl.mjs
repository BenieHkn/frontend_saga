import { _ as _export_sfc, a as __nuxt_component_0$4, g as __nuxt_component_2$1, v as __nuxt_component_1$1, m as mergeConfig, e as useUI, i as twJoin, t as twMerge, O as getNuxtLinkProps, P as dropdown, f as appConfig } from './server.mjs';
import __nuxt_component_0 from './Kbd-rZqaVajf.mjs';
import { defineComponent, resolveComponent, mergeProps, withCtx, renderSlot, createVNode, resolveDynamicComponent, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, Transition, toRef, computed, ref, watch, watchEffect, nextTick, provide, inject, useId, useSSRContext } from 'vue';
import { s, i, o as o$1, A as A$1, u, N, a as o } from './keyboard-BCt0ZeLv.mjs';
import { w } from './use-outside-click-BqFFeIfQ.mjs';
import { s as s$1 } from './use-resolve-button-type-CCTzT7JK.mjs';
import { p } from './use-text-value-CScX7TKV.mjs';
import { u as u$1, i as i$1, f, c } from './calculate-active-index-BN0T2bP2.mjs';
import { l, i as i$2, t } from './open-closed-DaveoKA1.mjs';
import { w as w$1, h, O as O$1, v, N as N$1, _ } from './focus-management-CclPs0xY.mjs';
import { v as defu } from '../_/nitro.mjs';
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o$12, { slots: M, attrs: i2 }) {
  ...
  }, computed(() => I.value === 0)), provide(A, l2), t(computed(() => u(I.value, { [0]: i$2.Open, [1]: i$2.Closed }))), () => {
  ...
  let g = s$1(computed(() => ({ as: o$2.as, type: M.type })), e.buttonRef);
  return () => {
    var n;
  ...
  I({ el: e.itemsRef, $el: e.itemsRef }), i$1({ container: computed(() => o$1(e.itemsRef)), enabled: computed(() => e.menuState.value === 0), accept(t2) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.22.3_axios@1.13._bfe54df56123b11f40786e0ab114d592/node_modules/@nuxt/ui/dist/runtime/components/elements/Dropdown.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Dropdown = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { Dropdown as default };
//# sourceMappingURL=Dropdown-CgjehQNl.mjs.map
