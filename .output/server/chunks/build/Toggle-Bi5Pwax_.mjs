import { _ as _export_sfc, g as __nuxt_component_2$1, m as mergeConfig, e as useUI, t as twMerge, i as twJoin, f as appConfig } from './server.mjs';
import { defineComponent, resolveComponent, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, toRef, computed, inject, ref, h, Fragment, unref, provide, useId, useSSRContext } from 'vue';
import { d as d$1, p } from './form-DsUILy5F.mjs';
import { s, i, o as o$1, A, E as E$1, T, a as o } from './keyboard-BCt0ZeLv.mjs';
import { s as s$1 } from './use-resolve-button-type-CCTzT7JK.mjs';
import { f, u } from './hidden-e5tlhUcy.mjs';
import { k } from './description-BSAkQQqZ.mjs';
...
let ue = defineComponent({ name: "Switch", emits: { "update:modelValue": (l) => true }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: true }, form: { type: String, optional: true }, name: { type: String, optional: true }, value: { type: String, optional: true }, id: { type: String, default: null }, disabled: { type: Boolean, default: false }, tabIndex: { type: Number, default: 0 } }, inheritAttrs: false, setup(l, { emit: c, attrs: i$1, slots: r, expose: f$1 }) {
  ...
  let E2 = ref(null), o$2 = n === null ? E2 : n.switchRef, L = s$1(computed(() => ({ as: l.as, type: i$1.type })), o$2);
  f$1({ el: o$2, $el: o$2 });
  function D(e) {
    e.preventDefault(), m();
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.22.3_axios@1.13._bfe54df56123b11f40786e0ab114d592/node_modules/@nuxt/ui/dist/runtime/components/forms/Toggle.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { __nuxt_component_3 as default };
//# sourceMappingURL=Toggle-Bi5Pwax_.mjs.map
