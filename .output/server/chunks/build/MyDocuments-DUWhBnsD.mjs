...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    useTransfertsStore();
    useHead({
      title: "Documents re\xE7us - Sagar Revolution"
    });
    const columns = [
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (!entite_user || !entite_user.id) {
          console.error("\u274C Aucune fonction user s\xE9lectionn\xE9e");
          error.value = "Aucune fonction user s\xE9lectionn\xE9e";
          toast.add({
            title: "Erreur",
            description: "Aucune fonction user s\xE9lectionn\xE9e. Veuillez vous reconnecter.",
            color: "red",
            timeout: 1500
          });
          return;
  ...
  `;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 max-w-[1400px] mx-auto" }, _attrs))} data-v-5985e7ec><div class="flex items-center justify-between mb-6" data-v-5985e7ec><h1 class="flex items-center gap-3 text-2xl font-bold text-slate-800" data-v-5985e7ec>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "i-heroicons-inbox",
        class: "w-7 h-7 text-blue-600"
      }, null, _parent));
      _push(` Documents re\xE7us </h1><div class="flex items-center gap-3" data-v-5985e7ec><button class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-700 bg-white border border-slate-300 rounded-lg hover:bg-slate-50 transition-all hover:shadow-md" data-v-5985e7ec>`);
      _push(ssrRenderComponent(_component_Icon, {
      ...
      _push(ssrRenderComponent(_component_UBadge, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="text-sm" data-v-5985e7ec${_scopeId}>${ssrInterpolate(affectationData.value.length)} document${ssrInterpolate(affectationData.value.length > 1 ? "s" : "")}</span>`);
          } else {
            return [
      ...
      _push(`</div></div>`);
      if (error.value) {
        _push(`<div class="flex items-center gap-3 p-4 mb-5 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm" data-v-5985e7ec>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "i-heroicons-exclamation-triangle",
          class: "w-5 h-5 flex-shrink-0"
        }, null, _parent));
        _push(`<span class="flex-1" data-v-5985e7ec>${ssrInterpolate(error.value)}</span><button class="text-lg opacity-60 hover:opacity-100 transition-opacity" data-v-5985e7ec> \u2715 </button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (loading.value) {
        _push(`<div class="flex flex-col items-center justify-center py-16 gap-4" data-v-5985e7ec><div class="w-12 h-12 border-4 border-gray-200 border-t-blue-600 rounded-full animate-spin" data-v-5985e7ec></div><p class="text-sm text-slate-500" data-v-5985e7ec>Chargement des documents...</p></div>`);
      } else {
        _push(ssrRenderComponent(_component_DataTable, {
          ...
          "advanced-filters": withCtx(({ filters, onFilter }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" data-v-5985e7ec${_scopeId}><div data-v-5985e7ec${_scopeId}><label class="block text-xs font-medium text-gray-700 mb-1" data-v-5985e7ec${_scopeId}>Date d&#39;affectation</label><input${ssrRenderAttr("value", filters.date_affect)} type="date" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" data-v-5985e7ec${_scopeId}></div><div data-v-5985e7ec${_scopeId}><label class="block text-xs font-medium text-gray-700 mb-1" data-v-5985e7ec${_scopeId}>Date de retour attendue</label><input${ssrRenderAttr("value", filters.delai_traitement)} type="date" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" data-v-5985e7ec${_scopeId}></div><div data-v-5985e7ec${_scopeId}><label class="block text-xs font-medium text-gray-700 mb-1" data-v-5985e7ec${_scopeId}>Date de cl\xF4ture</label><input${ssrRenderAttr("value", filters.date_cloture)} type="date" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" data-v-5985e7ec${_scopeId}></div><div data-v-5985e7ec${_scopeId}><label class="block text-xs font-medium text-gray-700 mb-1" data-v-5985e7ec${_scopeId}>\xC9metteur</label><input${ssrRenderAttr("value", filters.emetteur)} placeholder="Filtrer par \xE9metteur..." class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" data-v-5985e7ec${_scopeId}></div></div>`);
            } else {
              return [
          ...
          "cell-reference_courrier": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800" data-v-5985e7ec${_scopeId}>${ssrInterpolate(value)}</span>`);
            } else {
              return [
          ...
          "cell-statut": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="${ssrRenderClass([getStatutClasses(value), "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold uppercase tracking-wide"])}" data-v-5985e7ec${_scopeId}><span class="${ssrRenderClass([getStatutDotClass(value), "w-2 h-2 rounded-full mr-1.5"])}" data-v-5985e7ec${_scopeId}></span> ${ssrInterpolate(value)}</span>`);
            } else {
              return [
                createVNode("span", {
          ...
          "cell-priority": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="${ssrRenderClass([getPriorityClasses(value), "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold uppercase tracking-wide"])}" data-v-5985e7ec${_scopeId}><span class="${ssrRenderClass([getPriorityDotClass(value), "w-2 h-2 rounded-full mr-1.5"])}" data-v-5985e7ec${_scopeId}></span> ${ssrInterpolate(value)}</span>`);
            } else {
              return [
                createVNode("span", {
          ...
          "cell-instructions": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="block max-w-[300px] line-clamp-2 text-xs text-slate-700"${ssrRenderAttr("title", value)} data-v-5985e7ec${_scopeId}>${ssrInterpolate(value || "Aucune instruction")}</span>`);
            } else {
              return [
                createVNode("span", {
          ...
          actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex gap-1.5 justify-end" data-v-5985e7ec${_scopeId}><button title="Voir les d\xE9tails" class="inline-flex items-center justify-center w-8 h-8 bg-amber-50 text-amber-700 border-amber-100 rounded-md hover:bg-amber-200 :hover:text-amber-900 hover:border-amber-900 transition-all group" data-v-5985e7ec${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
              ...
              if (isResponsable.value) {
                _push2(`<button${ssrIncludeBooleanAttr(!item.courrier_id) ? " disabled" : ""} title="Affecter ce courrier" class="inline-flex items-center justify-center w-8 h-8 bg-sky-50 text-sky-700 border-sky-100 rounded-md hover:bg-sky-200 :hover:text-sky-900 hover:border-sky-900 transition-all group" data-v-5985e7ec${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
          ...
          "cell-reference": withCtx(({ value, item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (item.url) {
                _push2(`<button class="inline-flex items-center gap-1.5 px-2.5 py-0.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 hover:border-blue-300 rounded-md transition-all group"${ssrRenderAttr("title", `Ouvrir le document ${value}`)} data-v-5985e7ec${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-document-text",
                  class: "w-3.5 h-3.5 group-hover:scale-110 transition-transform"
                }, null, _parent2, _scopeId));
                _push2(`<span data-v-5985e7ec${_scopeId}>${ssrInterpolate(value)}</span>`);
                _push2(ssrRenderComponent(_component_Icon, {
                ...
                _push2(`<span class="inline-flex items-center px-2.5 py-0.5 text-xs font-medium text-gray-600 bg-gray-100 rounded-md"${ssrRenderAttr("title", value)} data-v-5985e7ec${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-document-text",
          ...
          "selection-actions": withCtx(({ selected }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-red-700 bg-red-50 border border-red-200 rounded-md hover:bg-red-100 hover:border-red-300 transition-all" data-v-5985e7ec${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "i-heroicons-trash",
                class: "w-4 h-4"
              }, null, _parent2, _scopeId));
              _push2(` Supprimer (${ssrInterpolate(selected.length)}) </button><button class="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-md hover:bg-blue-100 hover:border-blue-300 transition-all" data-v-5985e7ec${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
...
const AffectationsListe = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-5985e7ec"]]);
const _sfc_main$1 = {
...
//# sourceMappingURL=MyDocuments-DUWhBnsD.mjs.map
