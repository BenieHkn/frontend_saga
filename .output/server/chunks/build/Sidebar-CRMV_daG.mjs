...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-7e55b2dd><nav class="flex-1 px-3 py-6 space-y-2 overflow-y-auto no-scrollbar" data-v-7e55b2dd><!--[-->`);
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (isExpanded.value) {
                _push2(`<span class="ml-4 font-bold overflow-hidden tracking-wide" data-v-7e55b2dd${_scopeId}>${ssrInterpolate(item.name)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              if (!isExpanded.value) {
                _push2(`<div class="absolute left-16 bg-emerald-700 text-white text-[10px] font-black uppercase tracking-widest px-3 py-2 rounded-md opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 shadow-xl" data-v-7e55b2dd${_scopeId}>${ssrInterpolate(item.name)}</div>`);
              } else {
                _push2(`<!---->`);
              }
            } else {
      ...
      _push(`<!--]--><div class="pt-4 mt-4 border-t border-gray-200" data-v-7e55b2dd><button class="flex items-center justify-between w-full px-4 py-3.5 text-gray-700 hover:text-gray-900 rounded-xl hover:bg-gray-100 transition-all" data-v-7e55b2dd><div class="flex items-center" data-v-7e55b2dd>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "heroicons:cog-6-tooth",
        class: "h-6 w-6 shrink-0"
      }, null, _parent));
      if (isExpanded.value) {
        _push(`<span class="ml-4 font-bold text-gray-900" data-v-7e55b2dd>Configuration</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      ...
      if (settingsMenuOpen.value && isExpanded.value) {
        _push(`<div class="ml-10 space-y-2 mt-2 animate-slide-down" data-v-7e55b2dd>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/entites",
          class: ["block text-sm px-3 py-2 rounded-lg font-bold transition-colors", [
            unref(route).path === "/entites" ? "bg-gradient-to-br from-emerald-700 to-blue-800 text-white shadow-lg" : "text-gray-700 hover:text-emerald-600 hover:bg-gray-100"
          ]]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/utilisateurs",
          class: ["block text-sm px-3 py-2 rounded-lg font-bold transition-colors", [
            unref(route).path === "/utilisateurs" ? "bg-gradient-to-br from-emerald-700 to-blue-800 text-white shadow-lg" : "text-gray-700 hover:text-emerald-600 hover:bg-gray-100"
          ]]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/point-critique",
          class: ["block text-sm px-3 py-2 rounded-lg font-bold transition-colors", [
            unref(route).path === "/point-critique" ? "bg-gradient-to-br from-emerald-700 to-blue-800 text-white shadow-lg" : "text-gray-700 hover:text-emerald-600 hover:bg-gray-100"
          ]]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/interim",
          class: ["block text-sm px-3 py-2 rounded-lg font-bold transition-colors", [
            unref(route).path === "/interim" ? "bg-gradient-to-br from-emerald-700 to-blue-800 text-white shadow-lg" : "text-gray-700 hover:text-emerald-600 hover:bg-gray-100"
          ]]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
      ...
      _push(`</div></nav><button class="absolute -right-5 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center z-[50] transition-all duration-500 group" data-v-7e55b2dd><div class="absolute inset-0 rounded-full transition-all duration-300 bg-gradient-to-br from-emerald-700 to-blue-800 backdrop-blur-md border border-white/40 shadow-[0_8_32_0_rgba(0,0,0,0.2)] group-hover:scale-110 group-hover:bg-emerald-500/80 before:content-[&#39;&#39;] before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-b before:from-white/40 before:to-transparent before:opacity-50" data-v-7e55b2dd><div class="absolute inset-[2px] rounded-full bg-gradient-to-tr from-emerald-400/20 to-white/30 opacity-60" data-v-7e55b2dd></div></div>`);
      _push(ssrRenderComponent(_component_Icon, {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7e55b2dd"]]);

export { _sfc_main$1 as _, __nuxt_component_1 as a };
//# sourceMappingURL=Sidebar-CRMV_daG.mjs.map
