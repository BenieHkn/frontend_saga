...
import { _ as _export_sfc, a as useRouter, n as navigateTo, c as useRuntimeConfig } from './server.mjs';
...
const useDestinataires = () => {
  ...
  const fetchDestinataires = async () => {
    ...
    try {
      ...
      console.log(`\u{1F3AF} Recherche de coll\xE8gues de m\xEAme rang pour l'entit\xE9: ${entite_user.id}`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-emerald-50/40" }, _attrs))} data-v-8a867c6d>`);
      _push(ssrRenderComponent(_sfc_main$3, {
        title: "Transferts",
        description: "Gestion des transferts de courriers"
      }, null, _parent));
      _push(`<div class="max-w-7xl mx-auto px-6 py-8" data-v-8a867c6d><div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8" style="${ssrRenderStyle({ "height": "calc(100vh - 300px)", "min-height": "600px" })}" data-v-8a867c6d><div class="flex flex-col" data-v-8a867c6d>`);
      _push(ssrRenderComponent(AffectationsCheckboxListe, { loading: unref(affectationsLoading) }, null, _parent));
      _push(`</div><div class="flex flex-col" data-v-8a867c6d>`);
...
const formTransfert = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8a867c6d"]]);

export { formTransfert as default };
//# sourceMappingURL=form-transfert-B7QyWEFk.mjs.map
