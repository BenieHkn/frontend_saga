...
const _sfc_main = {
  ...
  setup(__props) {
    const CourriersArrivesListe = defineAsyncComponent({
      loader: () => import('./CourriersArrivesListe-rply_gxW.mjs'),
      delay: 200,
      timeout: 15e3,
    ...
    const CourriersDepartsListe = defineAsyncComponent({
      loader: () => import('./CourriersDepartsListe-Bxaw3EiB.mjs'),
      delay: 200,
      timeout: 15e3
    });
    const CourriersDocumentsInternes = defineAsyncComponent({
      loader: () => import('./CourriersDocumentsInternes--73scjAW.mjs'),
      delay: 200,
      timeout: 15e3
    });
    const documentTypes = [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (isLoading.value) {
              ...
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(currentComponent.value), null, null), _parent2, _scopeId);
            }
            _push2(`</div>`);
          } else {
            return [
...
//# sourceMappingURL=AllCourriers-C_tId2Ek.mjs.map
