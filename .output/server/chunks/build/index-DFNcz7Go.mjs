...
import __nuxt_component_4 from './Select-BY_Jn5yn.mjs';
import __nuxt_component_0 from './Checkbox-Nzn56Oau.mjs';
...
import { _ as _sfc_main$1, P as Pagination } from './Pagination-s-gpqXxp.mjs';
...
const _sfc_main = {
  ...
  `;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-50" }, _attrs))} data-v-766c937d><div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6" data-v-766c937d><div class="flex items-center justify-between mb-6" data-v-766c937d><div data-v-766c937d><h1 class="text-2xl font-bold text-gray-900" data-v-766c937d>Documents</h1><p class="text-gray-600 mt-1" data-v-766c937d> Gestion des affectations et suivi des traitements </p></div></div><div class="bg-white border-b border-gray-200 mb-4" data-v-766c937d><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3" data-v-766c937d><div class="flex flex-wrap items-center justify-between gap-4" data-v-766c937d><div class="flex items-center space-x-4" data-v-766c937d><div class="relative" data-v-766c937d>`);
      ...
      _push(`</div><div class="flex items-center space-x-4" data-v-766c937d><div class="flex items-center space-x-2" data-v-766c937d><label class="text-sm text-gray-600" data-v-766c937d>Lignes par page:</label>`);
      ...
      if (showAdvancedFilters.value) {
        _push(`<div class="mt-4 p-4 bg-gray-50 rounded-lg" data-v-766c937d><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" data-v-766c937d><div data-v-766c937d><label class="block text-xs font-medium text-gray-700 mb-1" data-v-766c937d>Date d&#39;affectation</label>`);
        _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`</div><div data-v-766c937d><label class="block text-xs font-medium text-gray-700 mb-1" data-v-766c937d>Date de retour attendue</label>`);
        _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`</div><div data-v-766c937d><label class="block text-xs font-medium text-gray-700 mb-1" data-v-766c937d>Date de cl\xF4ture</label>`);
        _push(ssrRenderComponent(_component_UInput, {
        ...
        _push(`</div><div data-v-766c937d><label class="block text-xs font-medium text-gray-700 mb-1" data-v-766c937d>\xC9metteur</label>`);
        _push(ssrRenderComponent(_component_UInput, {
      ...
      _push(`</div></div><div class="max-w-7xl px-4 sm:px-6 lg:px-8 py-6" data-v-766c937d><div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden" data-v-766c937d><div class="border-b border-gray-200 px-6 py-3 bg-gray-50" data-v-766c937d><div class="flex items-center space-x-4" data-v-766c937d><span class="text-sm text-gray-700" data-v-766c937d>${ssrInterpolate(selectedRows.value.length)} s\xE9lectionn\xE9(s) </span>`);
      ...
      _push(`</div></div><div class="table-auto overflow-x-auto" data-v-766c937d><table class="w-full border-collapse" data-v-766c937d><thead class="bg-gray-50 border border-gray-400" data-v-766c937d><tr data-v-766c937d><!--[-->`);
      ssrRenderList(visibleColumns.value, (column) => {
        ...
        ])}" data-v-766c937d><div class="space-y-1" data-v-766c937d><div class="flex items-center justify-center gap-1" data-v-766c937d>`);
        if (column.type === "badge" || column.type === "document") {
          _push(`<span class="text-xs font-medium text-gray-700 uppercase tracking-wider" data-v-766c937d>${ssrInterpolate(column.label)}</span>`);
        } else {
          _push(`<!--[-->`);
          _push(ssrRenderComponent(_component_UInput, {
      ...
      _push(`<!--]--><th class="px-2 py-3 text-center border border-gray-400 bg-gray-100 w-16" data-v-766c937d>`);
      ...
      _push(`</th><th class="px-6 py-3 text-right border border-gray-400 bg-gray-100 w-32" data-v-766c937d><span class="text-xs font-medium text-gray-700 uppercase tracking-wider" data-v-766c937d> Actions </span></th></tr></thead><tbody class="bg-white" data-v-766c937d><!--[-->`);
      ssrRenderList(paginatedData.value, (item, index2) => {
        _push(`<tr class="${ssrRenderClass([getRowClasses(item.id, index2), "transition-colors"])}" data-v-766c937d><!--[-->`);
        ssrRenderList(visibleColumns.value, (column) => {
          ...
          if (column.type === "document") {
            _push(`<div class="flex justify-center" data-v-766c937d>`);
            if (item[column.key]) {
              _push(`<button class="text-blue-600 hover:text-blue-800 transition-colors p-1 rounded hover:bg-blue-50" title="Ouvrir le document" data-v-766c937d>`);
              ...
              _push(`<span class="text-gray-300" title="Aucun document" data-v-766c937d>`);
              _push(ssrRenderComponent(_component_Icon, {
                name: "i-heroicons-document-text",
                class: "h-5 w-5"
              }, null, _parent));
            ...
            _push(ssrRenderComponent(_component_UBadge, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<span class="flex items-center gap-1" data-v-766c937d${_scopeId}><span class="${ssrRenderClass([getPriorityColor(item[column.key]).dot, "w-2 h-2 rounded-full"])}" data-v-766c937d${_scopeId}></span> ${ssrInterpolate(item[column.key])}</span>`);
                } else {
                  return [
            ...
            _push(`<div class="flex justify-left" data-v-766c937d>`);
            _push(ssrRenderComponent(_component_UBadge, {
              color: "blue",
              variant: "soft",
              size: "xs"
            ...
            _push(`<div class="text-left" data-v-766c937d><span class="line-clamp-2 text-xs text-gray-700"${ssrRenderAttr("title", item[column.key])} data-v-766c937d>${ssrInterpolate(item[column.key])}</span></div>`);
          } else {
            _push(`<div data-v-766c937d>${ssrInterpolate(item[column.key])}</div>`);
          }
          _push(`</td>`);
        });
        _push(`<!--]--><td class="px-2 py-3 border border-gray-300 text-center" data-v-766c937d>`);
        _push(ssrRenderComponent(_component_UCheckbox, {
          "model-value": selectedRows.value.includes(item.id),
          onChange: ($event) => toggleRowSelection(item.id)
        }, null, _parent));
        _push(`</td><td class="px-6 py-4 border border-gray-300 text-right text-sm font-medium" data-v-766c937d><div class="flex justify-end space-x-2" data-v-766c937d>`);
        _push(ssrRenderComponent(_component_UButton, {
      ...
      if (paginatedData.value.length === 0) {
        _push(`<div class="text-center py-12" data-v-766c937d>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "i-heroicons-clipboard-document-list",
          class: "mx-auto h-12 w-12 text-gray-400"
        }, null, _parent));
        _push(`<h3 class="mt-2 text-sm font-medium text-gray-900" data-v-766c937d>Aucune affectation</h3><p class="mt-1 text-sm text-gray-500" data-v-766c937d> Commencez par cr\xE9er une nouvelle affectation de courrier. </p><div class="mt-6" data-v-766c937d>`);
        _push(ssrRenderComponent(_component_UButton, {
      ...
      if (paginatedData.value.length > 0) {
        _push(`<div class="border-t border-gray-200 px-6 py-4 bg-gray-50" data-v-766c937d><div class="flex items-center justify-between" data-v-766c937d><div class="text-sm text-gray-700" data-v-766c937d> Affichage de ${ssrInterpolate(startIndex.value + 1)} \xE0 ${ssrInterpolate(endIndex.value)} sur ${ssrInterpolate(filteredData.value.length)} r\xE9sultats `);
        if (filteredData.value.length !== affectationData.value.length) {
          _push(`<span class="ml-2" data-v-766c937d> (${ssrInterpolate(affectationData.value.length)} total) </span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (textFilterMenu.value.show) {
        _push(`<div class="fixed z-50 bg-white border border-gray-300 rounded-lg shadow-lg min-w-80 max-h-96" style="${ssrRenderStyle({ left: textFilterMenu.value.x + "px", top: textFilterMenu.value.y + "px" })}" data-v-766c937d><div class="p-4" data-v-766c937d><div class="flex items-center justify-between mb-3" data-v-766c937d><h3 class="text-sm font-medium text-gray-900" data-v-766c937d> Filtre - ${ssrInterpolate(getColumnLabel(textFilterMenu.value.column))}</h3><div class="flex items-center space-x-2" data-v-766c937d>`);
        ...
        _push(`<div class="max-h-48 overflow-y-auto border border-gray-200 rounded" data-v-766c937d><div class="flex items-center px-3 py-2 hover:bg-gray-50 cursor-pointer border-b" data-v-766c937d>`);
        _push(ssrRenderComponent(_component_UCheckbox, {
        ...
        _push(`<span class="text-sm text-gray-700" data-v-766c937d>(S\xE9lectionner tous)</span></div><!--[-->`);
        ssrRenderList(getFilteredOptions(textFilterMenu.value.column), (option) => {
          _push(`<div class="flex items-center px-3 py-2 hover:bg-gray-50 cursor-pointer" data-v-766c937d>`);
          _push(ssrRenderComponent(_component_UCheckbox, {
            "model-value": isSelected(textFilterMenu.value.column, option.value),
            size: "sm",
            class: "mr-3"
          }, null, _parent));
          _push(`<div class="flex items-center flex-1" data-v-766c937d><span class="text-sm text-gray-700" data-v-766c937d>${ssrInterpolate(option.label)}</span></div></div>`);
        });
        _push(`<!--]--></div><div class="flex justify-between items-center mt-3 pt-3 border-t border-gray-200" data-v-766c937d><span class="text-xs text-gray-500" data-v-766c937d>${ssrInterpolate(getSelectedCount(textFilterMenu.value.column))} s\xE9lectionn\xE9(s) </span>`);
        if (getSelectedCount(textFilterMenu.value.column) > 0) {
          _push(ssrRenderComponent(_component_UButton, {
      ...
      if (textFilterMenu.value.show) {
        _push(`<div class="fixed inset-0 z-40" data-v-766c937d></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-766c937d"]]);

export { index as default };
//# sourceMappingURL=index-DFNcz7Go.mjs.map
