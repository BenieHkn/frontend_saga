...
import { u as useHead, _ as _export_sfc, d as __nuxt_component_1$1, n as navigateTo, b as useRuntimeConfig, r as useToast$1 } from './server.mjs';
import __nuxt_component_2 from './Input-50cchghJ.mjs';
import __nuxt_component_3 from './Textarea-B6iki0ql.mjs';
import { _ as __nuxt_component_4 } from './DocumentPreview-D_2OLyBk.mjs';
...
let nextId = 0;
const useToast = () => {
  const add = (message, type = "info", duration = 3e3) => {
...
//# sourceMappingURL=form_document_interne-BN_6lWUu.mjs.map
