import { _ as _export_sfc, d as __nuxt_component_1, m as mergeConfig, e as useUI, L as useScroll, M as useElementSize, N as useResizeObserver, t as twMerge, f as appConfig } from './server.mjs';
import { defineComponent, mergeProps, toRef, ref, computed, useSSRContext } from 'vue';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _ctx.attrs, { dir: _ctx.dir }, _attrs))} data-v-e7cda8d9><div class="${ssrRenderClass([_ctx.ui.container, "no-scrollbar"])}" data-v-e7cda8d9><!--[-->`);
  ssrRenderList(_ctx.items, (item, index) => {
    _push(`<div class="${ssrRenderClass(_ctx.ui.item)}"${ssrRenderAttr("role", _ctx.indicators ? "tabpanel" : null)} data-v-e7cda8d9>`);
  ...
  _push(`<!--]--></div>`);
  if (_ctx.arrows) {
    _push(`<div class="${ssrRenderClass(_ctx.ui.arrows.wrapper)}" data-v-e7cda8d9>`);
  ...
  if (_ctx.indicators) {
    _push(`<div role="tablist" class="${ssrRenderClass(_ctx.ui.indicators.wrapper)}" data-v-e7cda8d9><!--[-->`);
    ssrRenderList(_ctx.pages, (page) => {
      ssrRenderSlot(_ctx.$slots, "indicator", {
        ...
        ])}"${ssrRenderAttr("aria-label", `set slide ${page}`)} data-v-e7cda8d9></button>`);
      }, _push, _parent);
    });
    _push(`<!--]--></div>`);
  } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.22.3_axios@1.13._bfe54df56123b11f40786e0ab114d592/node_modules/@nuxt/ui/dist/runtime/components/elements/Carousel.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Carousel = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-e7cda8d9"]]);

export { Carousel as default };
//# sourceMappingURL=Carousel-C7cTTxO7.mjs.map
