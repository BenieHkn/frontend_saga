...
import { m as mergeConfig, g as __nuxt_component_2$1, e as useUI, I as getSlotsChildren, i as twJoin, f as appConfig } from './server.mjs';
    ...
    const vNodeChildren = computed(() => {
      ...
      vNodeSlots[2] = h("ol", { class: ui.value.list }, labels.value.map((label, key) => {
        ...
        return h("li", { class: labelClass.value }, [
          h(__nuxt_component_2$1, { name: (_b = (_a = clones.value[key]) == null ? void 0 : _a.props.icon) != null ? _b : props.icon }),
...
//# sourceMappingURL=MeterGroup-BP3KKXRA.mjs.map
