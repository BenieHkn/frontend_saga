  ...
  setup(__props) {
    ...
    const transformerDonneesAPI = (reponseAPI) => {
      ...
      return reponseAPI.data.map((rattachement) => {
        ...
        return {
          ...
          doc_arrivee: ((_c = rattachement == null ? void 0 : rattachement.document) == null ? void 0 : _c.url) ? `http://localhost:8000${rattachement.document.url}` : "",
          link: "\u2192",
          ...
          doc_depart: ((_f = rattachement == null ? void 0 : rattachement.reponse) == null ? void 0 : _f.url) ? `http://localhost:8000${rattachement.reponse.url}` : "",
    ...
    `,
      ...
      try {
        await Promise.all(
          selectedIds.map(
            (id) => $fetch(`http://localhost:8000/api/reponses/${id}`, {
              method: "DELETE",
              headers: {
                Authorization: `Bearer ${authToken.value}`
              }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 max-w-[1400px] mx-auto" }, _attrs))} data-v-cc2188bf><div class="flex items-center justify-between mb-6" data-v-cc2188bf><h1 class="flex items-center gap-3 text-2xl font-bold text-slate-800" data-v-cc2188bf>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "i-heroicons-link",
        class: "w-7 h-7 text-blue-600"
      }, null, _parent));
      _push(` Rattachements de Courriers </h1><div class="flex items-center gap-3" data-v-cc2188bf><button class="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-700 bg-white border border-slate-300 rounded-lg hover:bg-slate-50 transition-all hover:shadow-md" data-v-cc2188bf>`);
      _push(ssrRenderComponent(_component_Icon, {
      ...
      _push(`</div></div>`);
      if (error.value) {
        _push(`<div class="flex items-center gap-3 p-4 mb-5 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm" data-v-cc2188bf>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "i-heroicons-exclamation-triangle",
          class: "w-5 h-5 flex-shrink-0"
        }, null, _parent));
        _push(`<span class="flex-1" data-v-cc2188bf>${ssrInterpolate(error.value)}</span><button class="text-lg opacity-60 hover:opacity-100 transition-opacity" data-v-cc2188bf> \u2715 </button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (loading.value) {
        _push(`<div class="flex flex-col items-center justify-center py-16 gap-4" data-v-cc2188bf><div class="w-12 h-12 border-4 border-gray-200 border-t-blue-600 rounded-full animate-spin" data-v-cc2188bf></div><p class="text-sm text-slate-500" data-v-cc2188bf>Chargement des rattachements...</p></div>`);
      } else {
        _push(ssrRenderComponent(_component_DataTable, {
          ...
          "advanced-filters": withCtx(({ filters, onFilter }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" data-v-cc2188bf${_scopeId}><div data-v-cc2188bf${_scopeId}><label class="block text-xs font-medium text-gray-700 mb-1" data-v-cc2188bf${_scopeId}>Date de cr\xE9ation</label><input${ssrRenderAttr("value", filters.created_at)} type="date" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" data-v-cc2188bf${_scopeId}></div></div>`);
            } else {
              return [
          ...
          "selection-actions": withCtx(({ selected }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-red-700 bg-red-50 border border-red-200 rounded-md hover:bg-red-100 hover:border-red-300 transition-all" data-v-cc2188bf${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
          ...
          "cell-ref_arrivee": withCtx(({ value, item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (item.doc_arrivee) {
                _push2(`<button class="inline-flex items-center gap-1.5 px-2.5 py-0.5 text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 hover:border-blue-300 rounded-full transition-all group"${ssrRenderAttr("title", `Ouvrir le document ${value}`)} data-v-cc2188bf${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-document-text",
                  class: "w-3.5 h-3.5 group-hover:scale-110 transition-transform"
                }, null, _parent2, _scopeId));
                _push2(`<span data-v-cc2188bf${_scopeId}>${ssrInterpolate(value)}</span>`);
                _push2(ssrRenderComponent(_component_Icon, {
                ...
                _push2(`<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600"${ssrRenderAttr("title", value)} data-v-cc2188bf${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-document-text",
          ...
          "cell-ref_depart": withCtx(({ value, item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (item.doc_depart) {
                _push2(`<button class="inline-flex items-center gap-1.5 px-2.5 py-0.5 text-xs font-medium text-green-700 bg-green-50 hover:bg-green-100 border border-green-200 hover:border-green-300 rounded-full transition-all group"${ssrRenderAttr("title", `Ouvrir le document ${value}`)} data-v-cc2188bf${_scopeId}>`);
                _push2(ssrRenderComponent(_component_Icon, {
                  name: "i-heroicons-document-text",
                  class: "w-3.5 h-3.5 group-hover:scale-110 transition-transform"
                }, null, _parent2, _scopeId));
          ...
          "cell-link": withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex justify-center" data-v-cc2188bf${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
          ...
          "cell-objet_arrivee": withCtx(({ value }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="block max-w-[300px] line-clamp-2 text-xs text-slate-700"${ssrRenderAttr("title", value)} data-v-cc2188bf${_scopeId}>${ssrInterpolate(value || "Sans objet")}</span>`);
            } else {
              return [
                createVNode("span", {
          ...
          actions: withCtx(({ item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex gap-1.5 justify-end" data-v-cc2188bf${_scopeId}><button title="Voir les d\xE9tails" class="inline-flex items-center justify-center w-8 h-8 bg-amber-50 text-amber-700 border-amber-100 rounded-md hover:bg-amber-200 hover:border-amber-900 transition-all group" data-v-cc2188bf${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "i-heroicons-eye",
                class: "w-4 h-4 group-hover:text-yellow-600"
              }, null, _parent2, _scopeId));
              _push2(`</button><button title="Supprimer" class="inline-flex items-center justify-center w-8 h-8 bg-red-50 text-red-700 border-red-100 rounded-md hover:bg-red-200 hover:border-red-900 transition-all group" data-v-cc2188bf${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "i-heroicons-trash",
          ...
          "empty-state": withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="text-center py-12" data-v-cc2188bf${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "i-heroicons-link-slash",
                class: "mx-auto h-16 w-16 text-gray-400 mb-4"
              }, null, _parent2, _scopeId));
              _push2(`<h3 class="text-lg font-medium text-gray-900 mb-2" data-v-cc2188bf${_scopeId}>Aucun rattachement</h3><p class="text-sm text-gray-500 mb-6" data-v-cc2188bf${_scopeId}> Commencez par cr\xE9er un rattachement entre un courrier arriv\xE9e et un courrier d\xE9part. </p>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cc2188bf"]]);

export { index as default };
//# sourceMappingURL=index-hJYRlpCj.mjs.map
