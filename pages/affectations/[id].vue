          ...
          <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6 space-y-6">
              ...
              <div>
                ...
                <input v-model="editData.date_affect" type="date"
              ...
              <div>
                <label class="block text-sm font-semibold text-slate-700 mb-2">
                  <Icon name="i-heroicons-clock" class="w-4 h-4 inline mr-1" />
            ...
            <div class="flex items-center justify-between gap-3 px-6 py-4 border-t border-slate-200 bg-slate-50">
              ...
              <div class="flex gap-3 ml-auto">
                <UButton @click="handleCancel" color="gray" variant="outline" size="lg">
                  Annuler
                </UButton>
...
const loadAffectation = async () => {
  try {
    ...
    editData.date_affect = affectation.value.date_affect || ''
    editData.instructions = affectation.value.instructions || ''
    editData.delai_traitement = affectation.value.delai_traitement || ''
  } catch (error) {
...
const handleSubmit = async () => {
  try {
    ...
    await $fetch(`/api/affectations/${route.params.id}`, {
      ...
      body: {
        date_affect: editData.date_affect,
        instructions: editData.instructions,
        delai_traitement: editData.delai_traitement,
      },
    })
